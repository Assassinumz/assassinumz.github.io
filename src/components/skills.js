...
function Skill(props) {
	return (
		<div
			className={
				"w-48 md:w-36 px-1 py-2 md:py-1 m-2 rounded-lg cursor-pointer flex flex-row items-center bg-slate-800 transition ease-in-out duration-300 " +
				`${props.color}`
			}
		>
		...
		<div id="skills" className="w-full flex justify-center mt-52">
			<div className="w-4/5 md:w-3/5">
				<h1 className="text-3xl font-poppins">
					<span className="text-primary tracking-widest">2.</span>
					<span className="font-semibold ml-2">TECH STACK</span>
				</h1>
				...
				<div className="w-full flex flex-col pt-12 justify-center items-center font-roboto flex-wrap">
					...
					<div className="flex flex-row mt-3 mb-10 w-full flex-wrap justify-center md:justify-start">
						...
						<Skill
							img={fastapi}
							sname="FastAPI"
							color="hover:bg-fastapi"
						/>
						<Skill
							img={mongo}
							sname="MongoDB"
							color="hover:bg-mongo"
						/>
						<Skill
							img={mysql}
							sname="MySQL"
					...
					<div className="flex flex-row mt-3 w-full flex-wrap justify-center md:justify-start">
						...
						<Skill
							img={docker}
							sname="Docker"
							color="hover:bg-docker"
						/>
						<Skill
							img={azure}
							sname="Azure"
							color="hover:bg-azure"
						/>
						<Skill
							img={figma}
							sname="Figma"
